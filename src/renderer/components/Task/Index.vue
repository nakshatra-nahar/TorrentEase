  ...
  export default {
    ...
    methods: {
      ...
      showAddTaskDialog (uri, options = {}) {
        ...
        console.log('[TorrentEase] show add task dialog options: ', options)
      ...
      batchDeleteTaskFiles (taskList) {
        ...
        Promise.allSettled(promises).then(results => {
          console.log('[TorrentEase] batch delete task files: ', results)
        })
      },
      ...
      handleRestartTask (payload) {
        ...
        this.$store.dispatch('task/getTaskOption', gid)
          .then((data) => {
            console.log('[TorrentEase] get task option:', data)
