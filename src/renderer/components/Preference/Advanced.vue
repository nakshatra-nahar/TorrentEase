        ...
        >
          ...
          >
            ...
            <div class="el-form-item__info" style="margin-top: 8px;">
              <a target="_blank" href="https://github.com/agalwood/TorrentEase/wiki/Proxy" rel="noopener noreferrer">
        ...
        >
          ...
          <el-row style="margin-bottom: 8px;">
            ...
            >
              ...
              <div class="el-form-item__info" style="margin-top: 8px;">
                <a target="_blank" href="https://github.com/agalwood/TorrentEase/wiki/RPC" rel="noopener noreferrer">
    ...
    methods: {
      ...
      submitForm (formName) {
        this.$refs[formName].validate((valid) => {
          if (!valid) {
            console.error('[TorrentEase] preference form valid:', valid)
            return false
          }
          ...
          console.log('[TorrentEase] preference changed data:', data)
