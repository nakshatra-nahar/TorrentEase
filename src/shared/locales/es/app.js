export default {
  ...
  'update-available-message': 'Hay una nueva versión de TorrentEase, ¿Actualizar ahora?',
  ...
  'unhide': 'Mostrar Todo',
  'show': 'Mostrar TorrentEase',
  'quit': 'Salir de TorrentEase',
