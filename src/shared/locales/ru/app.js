export default {
  ...
  'update-available-message': 'Новая версия TorrentEase доступна для скачивания, скачать сейчас?',
  ...
  'hide': 'Спрятать TorrentEase',
  'hide-others': 'Спрятать все остальное',
  'unhide': 'Отобразить все',
  'show': 'Отобразить TorrentEase',
  'quit': 'Закрыть TorrentEase',
