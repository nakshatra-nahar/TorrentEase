export default {
  ...
  'update-available-message': 'Новата версия на TorrentEase е достъпна за изтегляне, Изтеглете сега?',
  ...
  'hide': 'Скрия TorrentEase',
  'hide-others': 'Скрийте всичко останало',
  'unhide': 'Показване на всички',
  'show': 'Показване TorrentEase',
  'quit': 'Затваряне TorrentEase',
