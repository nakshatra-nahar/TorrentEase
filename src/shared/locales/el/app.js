export default {
  ...
  'about': 'Σχετικά με το TorrentEase',
  ...
  'update-available-message': 'Μία νέα έκδοση του TorrentEase είναι διαθέσιμη, ενημέρωση τώρα;',
  ...
  'hide': 'Κρύψε το TorrentEase',
  'hide-others': 'Κρύψε τα υπόλοιπα',
  'unhide': 'Εμφάνιση όλων',
  'show': 'Εμφάνιση του TorrentEase',
  'quit': 'Κλείσιμο του TorrentEase',
