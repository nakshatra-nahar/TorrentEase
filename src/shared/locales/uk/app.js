export default {
  ...
  'update-available-message': 'Нова версія TorrentEase доступна для завантаження, завантажити зараз?',
  ...
  'hide': 'Сховати TorrentEase',
  'hide-others': 'Сховати інше',
  'unhide': 'Відобразити все',
  'show': 'Відобразити TorrentEase',
  'quit': 'Закрити TorrentEase',
